...
class IndexController extends Controller
{
    ...
    public function RentProperty(){
        ...
        return view('frontend.property.rent_property',compact('property','bproperty'));
     ...
     public function BuyProperty(){
        ...
        return view('frontend.property.buy_property',compact('property','rproperty'));
    ...
    public function PropertyType($id){
        ...
        $pkind = PropertyType::where('id',$id)->first();

        return view('frontend.property.property_type',compact('property','pkind'));
    ...
    public function StateDetails($id){
       ...
       return view('frontend.property.state_property',compact('property','bstate','rproperty','bproperty'));
    ...
    public function BuyPropertySearch(Request $request){
       ...
       return view('frontend.property.proerty_search',compact('property','rproperty','bproperty'));
