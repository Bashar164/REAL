...
class AgentPropertyController extends Controller
{
    ...
    public function AgentStoreProperty(Request $request){
        ...
        Image::make($image)->save('upload/property/thumbnail/'.$name_gen);
        ...
        foreach($images as $img){
            ...
            Image::make($img)->save('upload/property/multi_image/'.$make_name);
         ...
         /// End Multi Images Upload From Here///
    ...
    public function AgentUpdatePropertyMultiimage(Request $request){
        ...
        foreach($imgs as $id => $imge){
        $imgDel = MultiImage::findOrFail($id);
        unlink($imgDel->photo_name);

        $make_name = hexdec(uniqid()).'.'.$imge->getClientOriginalExtension();
        Image::make($imge)->save('upload/property/multi_image/'.$make_name);
        $uploadPath = 'upload/property/multi_image/'.$make_name;
    ...
    public function AgentStoreMultiimage(Request $request){

        $new_multi = $request->imageid;
        $image = $request->file('multi_img');

        $make_name = hexdec(uniqid()).'.'.$image->getClientOriginalExtension();
        Image::make($image)->save('upload/property/multi_image/'.$make_name);
        $uploadPath = 'upload/property/multi_image/'.$make_name;
    ...
    public function AgentDeleteProperty($id){
        ...
        $facilitiesData = Facility::where('property_id',$id);
    ...
    public function StoreBusinessPlan(Request $request){
        ...
        $notification=array(
            'message'=>'You have purchese Basic Package Succesfully',
            'alert-type'=>'success'
        );
        return redirect()->route('agent.all.property')->with($notification);
    }// End Method
    ...
    public function StoreProfessionalPlan(Request $request){
        ...
        $notification=array(
            'message'=>'You have purchese Professional Package Succesfully',
            'alert-type'=>'success'
        );
        return redirect()->route('agent.all.property')->with($notification);
    ...
    public function AgentMessageDetails($id){
        ...
        $details = PropertyMessage::findOrFail($id);
        return view('agent.message.message_details', compact('usermsg','details'));
