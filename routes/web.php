...
//Property Type All Route
    ...
    Route::controller(PropertyTypeController::class)->group(function(){
        ...
        Route::controller(PropertyController::class)->group(function(){
            ...
            Route::get('/backend/message/details', 'AdminMessageDetails')->name('backend.message.details');
...
Route::middleware(['auth','roles:agent'])->group(function(){
 ...
 Route::controller(AgentPropertyController::class)->group(function(){
    ...
    Route::post('/agent/store/multiimage', 'AgentStoreMultiimage')->name('agent.store.multiimage');
    ...
    Route::post('/agent/update/schedule', 'AgentUpdateSchedule')->name('agent.update.schedule');
         ...
         // Agent Buy Package All Route From Admin
         Route::controller(AgentPropertyController::class)->group(function(){
...
Route::get('/admin/comment/rebly/{id}', [BlogController::class, 'AdminBlogRebly'])->name('admin.comment.rebly');

Route::post('/reply/message', [BlogController::class, 'ReplyMessage'])->name('reply.message');


//All Schedule Messge Request Route
