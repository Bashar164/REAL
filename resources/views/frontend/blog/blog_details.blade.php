...
@endphp
                          ...
                          @foreach($reply as $rep)
                            ...
                            <div class="comment replay-comment">
                                <figure class="thumb-box">
                                    <img src="{{ url('upload/TanTan.jpg')}}" alt="">
                                </figure>
                                <div class="comment-inner">
                                    <div class="comment-info clearfix">
                                        <h5>{{ $rep->subjet }}</h5>
                    ...
                    <div class="comments-form-area">
                        ...
                        @else
                        <p><b> Please Login first <a href="{{route('login')}}">     Login Here </a></b></p>
                        @endauth
                ...
                <div class="blog-sidebar">
                    ...
                    <div class="sidebar-widget post-widget">
                        ...
                        <div class="post-inner">
                        	...
                        	@foreach($dpost as $dpo)

                            <div class="post">
                                <figure class="post-thumb"><a href="blog-details.html"><img src="{{ asset($dpo->post_image)}}" alt=""></a></figure>
                                <h5><a href="blog-details.html">{{$dpo->post_title}}</a></h5>
                                <span class="post-date">{{$dpo->created_at->format('M d Y')}}</span>
                            </div>
