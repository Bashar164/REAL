...
<section class="page-title-two bg-color-1 centred">
    <div class="pattern-layer">
        <div class="pattern-1" style="background-image: url{{asset('fronend/assets/images/shape/shape-9.png')}};"></div>
        <div class="pattern-2" style="background-image: url{{asset('fronend/assets/images/shape/shape-10.png')}};"></div>
    </div>
                ...
                <div class="property-sidebar default-sidebar">
                    <div class="author-widget sidebar-widget">
                        <div class="author-box">
                            ...
                            <figure class="author-thumb"><img src="{{  url('upload/TanTan.jpg')}}" alt=""></figure>
                            <div class="inner">
                                <h4>Admin</h4>
                                <ul class="info clearfix">
