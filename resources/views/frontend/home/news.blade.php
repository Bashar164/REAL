@php
$postc = App\Models\BlogPost::latest()->limit(3)->get();
@endphp
...
<section class="news-section sec-pad">
    <div class="auto-container">
        ...
        <div class="row clearfix">
            ...
            @foreach($postc as $item)

            <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                <div class="news-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image" ><a href="{{url('blog/details/'.$item->post_slug)}}"><img src="{{ asset($item->post_image) }}" style="hieght:250px; width: 370px;" alt=""></a></figure>
