                  ...
                  <table id="dataTableExample" class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>{{$key+1}}</td>
                        <td>
                            <img src="{{(!empty($item->user->photo)) ? url('upload/agent_images/'.$item->user->photo) : url('upload/no_image.jpg')}}" style="width: 70px; height:40px;" >
                        </td>
                        ...
                        <td>
                          ...
                          <a href="{{route('agent.package.invoice',$item->id)}}" class="btn btn-inverse-warning"> Download </a>
