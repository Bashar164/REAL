                  ...
                  <table id="dataTableExample" class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="{{route('agent.details.schedule',$item->id)}}" class="btn btn-inverse-info"> Details </a>

                          <a href="{{route('agent.delete.property',$item->id)}}" class="btn btn-inverse-danger" id="delete"> Delete </a>
                        </td>
                      </tr>
