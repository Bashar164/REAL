                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{route('agent.update.property')}}" id="myForm" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                     <input type="checkbox" name="hot" value="1" class="form-check-input" id="checkInline1" {{$property->hot == '1' ? 'checked' : ''}}>
                ...
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{route('agent.store.multiimage')}}" id="myForm" enctype="multipart/form-data">
                                @csrf
